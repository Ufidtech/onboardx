...
export default function Signup() {
  ...
  const initialRole = searchParams.get('role') === 'mentor' ? 'mentor' : 'learner'
  ...
  return (
    <div className="max-w-md mx-auto mt-12 px-4">
      <Card>
        <h1 className="font-display text-xl font-semibold mb-4 text-ink">Create your account</h1>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-sm text-gray-600">Phone (for WhatsApp connect)</label>
            <input
              required
              value={phone}
          ...
          {role === 'mentor' && (
            <div>
              <label className="text-sm text-gray-600">What can you mentor others in?</label>
              <input
                required
                value={specialty}
